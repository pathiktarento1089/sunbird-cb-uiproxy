...
proxiesV8.use('/v1/recommendations/courses',
  // tslint:disable-next-line: max-line-length
  proxyCreatorSunbirdSearch(express.Router(), `${CONSTANTS.KONG_API_BASE}/v1/recommendations/courses`)
)